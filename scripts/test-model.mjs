...
assert.equal(contactCostPriceShare(100, 1, 1000), 0.1);
assert.equal(contactCostPriceShare(100, 0, 1000), null);
assert.equal(contactCostPriceShare(100, -1, 1000), null);
assert.equal(contactCostPriceShare(100, 1, 0), null);
assert.equal(
  aggregate(
    [
